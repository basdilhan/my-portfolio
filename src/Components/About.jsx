    ...
    <section className={styles.container} id="about">
      ...
      <div className={styles.content}>
        <div className={styles.aboutText}>
          ...
          <p>
            I love crafting modern web and mobile applications, with a huge enthusiasm for building impactful solutions for the future. Learning new technologies excites me, and I often dive deep into areas like Machine Learning (ML) and Artificial Intelligence (AI).
          </p>
          <p>
